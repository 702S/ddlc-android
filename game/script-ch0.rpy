label ch0_main:
    ...
    s "هييييي!!"
    "أرى فتاة مزعجة تركض نحوي من بعيد ، وهي تلوح بذراعيها في الهواء وكأنها غافلة تمامًا عن أي اهتمام قد تلفته إلى نفسها."
    "تلك الفتاة هي سايوري ، جارتي وصديقي العزيز منذ أن كنا أطفالًا."
    "أنت تعرف ، نوع الصديق الذي لن ترى نفسك أبدًا تصنعه اليوم ، لكنه يعمل نوعًا ما لأنك تعرف بعضكما البعض لفترة طويلة؟"
